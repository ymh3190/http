...
var UnauthenticatedError = exports.UnauthenticatedError = /*#__PURE__*/function (_CustomError) {
  function UnauthenticatedError(message) {
    var _this;
    _classCallCheck(this, UnauthenticatedError);
    _this = _callSuper(this, UnauthenticatedError, [message]);
    _this.statusCode = 401;
    return _this;
  }
  _inherits(UnauthenticatedError, _CustomError);
  return _createClass(UnauthenticatedError);
}(_customError["default"]);