let app = Vue.createApp({
  ...
  // mounted hook
  // I'm going to fetch data on food.json
  async mounted() {
...
// we want to use on multiple different pages and interact with
app.component('sidebar', {
  props: ['toggle', 'cart', 'inventory', 'remove'],
  // computed watches the changes in variables
  // and we'll update the result
  // computed: {
  //   cartTotal() {
