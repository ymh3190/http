...
alter table table_name add column_name binary(16) after another_column_name;
...
create table user(
    id              binary(16) primary key comment '유저 아이디',
...
create table token(
    id              binary(16) primary key comment '토큰 아이디',
    user_id         binary(16) not null comment '유저 아이디 참조',
...
create table client(
    id              binary(16) primary key comment '거래처 아이디',
    ...
    creator_id      binary(16) not null comment '생성자',
    created_at      datetime not null default current_timestamp,
...
create table commodity(
    id              binary(16) primary key comment '원자재 아이디',
...
create table commodity_order_plan(
    id              binary(16) primary key,
    commodity_id    binary(16) not null,
    count           int not null,
...
create table product(
    id              binary(16) primary key comment '제품 아이디',
    name            varchar(10) not null,
